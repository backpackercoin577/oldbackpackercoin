#############################################################################
# Makefile for building: backpackercoin-qt
# Generated by qmake (2.01a) (Qt 4.8.7) on: Mon Apr 13 14:02:38 2020
# Project:  backpackercoin-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -o Makefile backpackercoin-qt.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DMINIUPNP_STATICLIB -DUSE_QRCODE -DUSE_UPNP=1 -DSTATICLIB -DUSE_IPV6=1 -DHAVE_BUILD_INFO -DLINUX -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++-64 -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtNetwork -I/usr/include/qt4/QtGui -I/usr/include/qt4 -Isrc -Isrc/json -Isrc/qt -Isrc/tor -Isrc/qt/plugins/mrichtexteditor -Isrc/xxhash -Isrc/lz4 -IC:/deps -Isrc/leveldb/include -Isrc/leveldb/helpers -IC:/deps/boost_1_57_0 -IC:/deps/db-4.8.30.NC/build_unix -IC:/deps/openssl-1.0.1l/include -IC:/deps/qrencode-3.4.4 -Ibuild -Ibuild
LINK          = g++
LFLAGS        = -m64 -fstack-protector-all --param ssp-buffer-size=1 -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lqrencode -LC:/deps/miniupnpc -lminiupnpc /media/rookie/Work/ProjectBackpacker/backpackercoin/src/leveldb/libleveldb.a /media/rookie/Work/ProjectBackpacker/backpackercoin/src/leveldb/libmemenv.a -lrt -LC:/deps/boost_1_57_0/stage/lib -LC:/deps/db-4.8.30.NC/build_unix -LC:/deps/openssl-1.0.1l -LC:/deps/qrencode-3.4.4/.libs -lssl -lcrypto -ldb_cxx -lz -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
DIST          = /usr/share/qt4/mkspecs/common/unix.conf \
		...
		backpackercoin-qt.pro
QMAKE_TARGET  = backpackercoin-qt
DESTDIR       = 
...
$(TARGET): /media/rookie/Work/ProjectBackpacker/backpackercoin/src/leveldb/libleveldb.a /media/rookie/Work/ProjectBackpacker/backpackercoin/build/build.h build/ui_coincontroldialog.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h build/ui_messagepage.h build/ui_sendmessagesentry.h build/ui_sendmessagesdialog.h build/ui_mrichtextedit.h build/ui_qrcodedialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: backpackercoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -o Makefile backpackercoin-qt.pro
...
/media/rookie/Work/ProjectBackpacker/backpackercoin/src/leveldb/libleveldb.a: FORCE
	cd /media/rookie/Work/ProjectBackpacker/backpackercoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-fpermissive -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/media/rookie/Work/ProjectBackpacker/backpackercoin/build/build.h: FORCE
	cd /media/rookie/Work/ProjectBackpacker/backpackercoin; /bin/sh share/genbuild.sh /media/rookie/Work/ProjectBackpacker/backpackercoin/build/build.h
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/backpackercoin.png \
		src/qt/res/icons/backpackercoin256.png \
		src/qt/res/icons/backpackercoin.png \
