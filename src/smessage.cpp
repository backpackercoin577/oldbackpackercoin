// Copyright (c) 2014 The backpackercoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("backpackercoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("backpackercoin-smsg-pow"); // Make this thread recognisable
